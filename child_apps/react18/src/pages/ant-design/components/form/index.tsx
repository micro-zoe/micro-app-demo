...
import FormValidateTriggerDemo from './validate-trigger'
import FormValidateDemo from './validate'
import FormPrefixPathDemo from './prefix-path'
import './index.css';
...
const FormDemo = () => (
  <div className="form-demo">
    ...
    <hr />
    <div id="components-form-demo-validate-trigger">
      <h2>ValidateTrigger 校验时机</h2>
      <div className="code-box-demo">
        <FormValidateTriggerDemo />
      </div>
    </div>
    <hr />
    <div id="components-form-demo-validate">
      <h2>Validate 仅校验</h2>
      <div className="code-box-demo">
        <FormValidateDemo />
      </div>
    ...
    <hr />
    <div id="components-form-demo-prefix-path">
      <h2>PrefixPath 字段路径前缀</h2>
      <div className="code-box-demo">
        <FormPrefixPathDemo />
      </div>
    </div>
    ...
    <hr />
    <div id="components-form-demo-dependencies">
      <h2>Dependencies 校验与更新依赖</h2>
      <div className="code-box-demo">
        <FormControlRefDemo />
      </div>
    </div>
