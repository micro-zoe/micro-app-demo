...
import { MaterialComponentDemoProgressBar } from './app-material-component-demo-progress-bar';
...
@NgModule({
  declarations: [
    ...
    MaterialComponentDemoProgressBar,
  ],
  imports: [
    CommonModule,
    FormsModule,
  ...
  exports: [MaterialComponentDemoProgressBar],
})
export class MaterialComponentDemoProgressBarModule { }
