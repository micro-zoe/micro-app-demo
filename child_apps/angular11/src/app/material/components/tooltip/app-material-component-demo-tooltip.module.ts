...
import { MaterialComponentDemoTooltip } from './app-material-component-demo-tooltip';
...
@NgModule({
  ...
  exports: [MaterialComponentDemoTooltip],
})
export class MaterialComponentDemoTooltipModule { }
