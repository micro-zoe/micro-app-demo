...
import { MaterialComponentDemoTabs } from './app-material-component-demo-tabs';
...
@NgModule({
  ...
  exports: [MaterialComponentDemoTabs],
})
export class MaterialComponentDemoTabsModule { }
