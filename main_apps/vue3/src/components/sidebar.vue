<template>
  <div id="sidebar">
    ...
    >
      ...
      <el-submenu index="vue2" title="child-vue2">
        <template #title>
      ...
      <el-submenu index="vue3">
        ...
        <el-menu-item index="/app-vue3/element-plus-1">
          <span class='menu-item-text'>element-plus 1.x</span>
        </el-menu-item>
        <el-menu-item index="/app-vue3/ant-design-vue-4">
          <span class='menu-item-text'>ant-design-vue 4.x</span>
        </el-menu-item>
      </el-submenu>
